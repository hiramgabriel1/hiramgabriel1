# 👨‍💻 @hiram.dev | Backend Developer
### 🚀 Building robust and scalable systems, one commit at a time

Hey there! I'm a passionate Backend Developer from Sonora, México, always exploring new ways to architect efficient, resilient, and performant server-side applications. With a knack for problem-solving and a deep dive into data structures, I thrive on crafting elegant solutions that power impactful products.

## 🎯 Current Focus

- 🔭 Working on: Building **scalable microservice architectures** using Go and Kubernetes
- 🌱 Learning: Diving deeper into **Event-Driven Patterns** and **Distributed Tracing**
- 👯 Looking to collaborate on: **Open Source projects** focused on API development, performance optimization, or developer tooling
- 💬 Ask me about: **API Design, Database Optimization, Cloud Deployment (AWS)**
- ⚡ Fun fact: I once debugged a production issue by tracing logs across three microservices while on vacation!

## 🛠️ Technology Arsenal

My expertise lies in developing robust backend solutions. Here's a glimpse into my tech stack:
